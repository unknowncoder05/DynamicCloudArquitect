# StoryArchitect Frontend

A React frontend for StoryArchitect - a web-based application for building, visualizing, and managing complex narratives.
...
This project is part of the StoryArchitect application.
